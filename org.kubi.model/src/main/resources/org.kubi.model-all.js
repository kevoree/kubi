    ...
    (function (kubi) {
        var KubiModel = (function (_super) {
            ...
            KubiModel.prototype.internal_create = function (key) {
                return new org.kubi.KubiUniverse(this, key);
            };
        ...
        var KubiUniverse = (function (_super) {
            ...
            function KubiUniverse(p_model, key) {
                _super.call(this, p_model, key);
            }
            KubiUniverse.prototype.internal_create = function (timePoint) {
                return new org.kubi.impl.KubiViewImpl(timePoint, this);
            };
            return KubiUniverse;
        })(org.kevoree.modeling.api.abs.AbstractKUniverse);
        ...
        (function (impl) {
            ...
            var DeviceImpl = (function (_super) {
                ...
                DeviceImpl.prototype.removeLinks = function (p_obj) {
                    this.mutate(org.kevoree.modeling.api.KActionType.REMOVE, org.kubi.meta.MetaDevice.REF_LINKS, p_obj);
                    return this;
                };
                DeviceImpl.prototype.getLinks = function () {
                    var task = new org.kevoree.modeling.api.abs.AbstractKDeferWrapper();
                    this.internal_ref(org.kubi.meta.MetaDevice.REF_LINKS, function (kObjects) {
                        var casted = new Array();
                        for (var i = 0; i < kObjects.length; i++) {
                            casted[i] = kObjects[i];
                        }
                ...
                DeviceImpl.prototype.setTechnology = function (p_obj) {
                    this.mutate(org.kevoree.modeling.api.KActionType.SET, org.kubi.meta.MetaDevice.REF_TECHNOLOGY, p_obj);
                    return this;
                };
                DeviceImpl.prototype.getTechnology = function () {
                    var task = new org.kevoree.modeling.api.abs.AbstractKDeferWrapper();
                    this.internal_ref(org.kubi.meta.MetaDevice.REF_TECHNOLOGY, function (kObjects) {
                        if (kObjects.length > 0) {
                            task.initCallback()(kObjects[0]);
                        }
                        else {
            ...
            var EcosystemImpl = (function (_super) {
                ...
                function EcosystemImpl(p_factory, p_uuid, p_metaClass) {
                    _super.call(this, p_factory, p_uuid, p_metaClass);
                }
                ...
                EcosystemImpl.prototype.addGroupes = function (p_obj) {
                    this.mutate(org.kevoree.modeling.api.KActionType.ADD, org.kubi.meta.MetaEcosystem.REF_GROUPES, p_obj);
                    return this;
                };
                EcosystemImpl.prototype.removeGroupes = function (p_obj) {
                    this.mutate(org.kevoree.modeling.api.KActionType.REMOVE, org.kubi.meta.MetaEcosystem.REF_GROUPES, p_obj);
                    return this;
                };
                EcosystemImpl.prototype.getGroupes = function () {
                    var task = new org.kevoree.modeling.api.abs.AbstractKDeferWrapper();
                    this.internal_ref(org.kubi.meta.MetaEcosystem.REF_GROUPES, function (kObjects) {
                        var casted = new Array();
                        for (var i = 0; i < kObjects.length; i++) {
                            casted[i] = kObjects[i];
                        }
                ...
                EcosystemImpl.prototype.addTechnologies = function (p_obj) {
                    this.mutate(org.kevoree.modeling.api.KActionType.ADD, org.kubi.meta.MetaEcosystem.REF_TECHNOLOGIES, p_obj);
                    return this;
                };
                EcosystemImpl.prototype.removeTechnologies = function (p_obj) {
                    this.mutate(org.kevoree.modeling.api.KActionType.REMOVE, org.kubi.meta.MetaEcosystem.REF_TECHNOLOGIES, p_obj);
                    return this;
                };
                EcosystemImpl.prototype.getTechnologies = function () {
                    var task = new org.kevoree.modeling.api.abs.AbstractKDeferWrapper();
                    this.internal_ref(org.kubi.meta.MetaEcosystem.REF_TECHNOLOGIES, function (kObjects) {
                        var casted = new Array();
                        for (var i = 0; i < kObjects.length; i++) {
                            casted[i] = kObjects[i];
                        }
            ...
            var KubiViewImpl = (function (_super) {
                ...
                function KubiViewImpl(p_now, p_universe) {
                    _super.call(this, p_now, p_universe);
                }
                KubiViewImpl.prototype.internalCreate = function (p_clazz, p_key) {
                    if (p_clazz == null) {
                        return null;
                    }
                    switch (p_clazz.index()) {
                        ...
                        case 7:
                            return new org.kubi.impl.SimulatedParameterImpl(this, p_key, p_clazz);
                        default:
            ...
            var SimulatedParameterImpl = (function (_super) {
                ...
                function SimulatedParameterImpl(p_factory, p_uuid, p_metaClass) {
                    _super.call(this, p_factory, p_uuid, p_metaClass);
                }
                ...
                SimulatedParameterImpl.prototype.setPeriod = function (p_obj) {
                    this.mutate(org.kevoree.modeling.api.KActionType.SET, org.kubi.meta.MetaSimulatedParameter.REF_PERIOD, p_obj);
                    return this;
                };
                SimulatedParameterImpl.prototype.getPeriod = function () {
                    var task = new org.kevoree.modeling.api.abs.AbstractKDeferWrapper();
                    this.internal_ref(org.kubi.meta.MetaSimulatedParameter.REF_PERIOD, function (kObjects) {
                        if (kObjects.length > 0) {
                            task.initCallback()(kObjects[0]);
                        }
                        else {
                ...
                SimulatedParameterImpl.prototype.view = function () {
                    return _super.prototype.view.call(this);
                };
            ...
            var TechnologyImpl = (function (_super) {
                ...
                TechnologyImpl.prototype.addDevices = function (p_obj) {
                    this.mutate(org.kevoree.modeling.api.KActionType.ADD, org.kubi.meta.MetaTechnology.REF_DEVICES, p_obj);
                    return this;
                };
                TechnologyImpl.prototype.removeDevices = function (p_obj) {
                    this.mutate(org.kevoree.modeling.api.KActionType.REMOVE, org.kubi.meta.MetaTechnology.REF_DEVICES, p_obj);
                    return this;
                };
                TechnologyImpl.prototype.getDevices = function () {
                    var task = new org.kevoree.modeling.api.abs.AbstractKDeferWrapper();
                    this.internal_ref(org.kubi.meta.MetaTechnology.REF_DEVICES, function (kObjects) {
                        var casted = new Array();
                        for (var i = 0; i < kObjects.length; i++) {
                            casted[i] = kObjects[i];
                        }
                ...
                TechnologyImpl.prototype.view = function () {
                    return _super.prototype.view.call(this);
                };
        ...
        (function (meta) {
            ...
            var MetaEcosystem = (function (_super) {
                ...
                function MetaEcosystem() {
                    _super.call(this, "org.kubi.Ecosystem", 0);
                    var temp_all = new Array();
                ...
                MetaEcosystem.ATT_NAME = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("name", 4, 0, true, org.kevoree.modeling.api.meta.PrimitiveTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                MetaEcosystem.REF_GROUPES = new org.kevoree.modeling.api.abs.AbstractMetaReference("groupes", 5, true, false, function () {
                    return org.kubi.meta.MetaGroup.getInstance();
                }, null, function () {
                    return org.kubi.meta.MetaEcosystem.getInstance();
                });
                MetaEcosystem.REF_TECHNOLOGIES = new org.kevoree.modeling.api.abs.AbstractMetaReference("technologies", 6, true, false, function () {
                    return org.kubi.meta.MetaTechnology.getInstance();
                }, null, function () {
                    return org.kubi.meta.MetaEcosystem.getInstance();
                });
            ...
            var MetaGroup = (function (_super) {
                ...
                function MetaGroup() {
                    _super.call(this, "org.kubi.Group", 1);
                    var temp_all = new Array();
            ...
            var MetaSimulatedParameter = (function (_super) {
                ...
                function MetaSimulatedParameter() {
                    _super.call(this, "org.kubi.SimulatedParameter", 7);
                    var temp_all = new Array();
                    ...
                    var temp_references = new Array();
                    temp_all[6] = MetaSimulatedParameter.REF_PERIOD;
                    var temp_operations = new Array();
                    this.init(temp_all);
                }
                ...
                MetaSimulatedParameter.ATT_UNIT = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("unit", 4, 0, false, org.kevoree.modeling.api.meta.PrimitiveTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                MetaSimulatedParameter.ATT_VALUETYPE = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("valueType", 5, 0, false, org.kevoree.modeling.api.meta.PrimitiveTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                MetaSimulatedParameter.ATT_PRECISION = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("precision", 6, 0, false, org.kevoree.modeling.api.meta.PrimitiveTypes.FLOAT, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                MetaSimulatedParameter.ATT_NAME = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("name", 7, 0, false, org.kevoree.modeling.api.meta.PrimitiveTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                MetaSimulatedParameter.ATT_RANGE = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("range", 8, 0, false, org.kevoree.modeling.api.meta.PrimitiveTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                MetaSimulatedParameter.ATT_VALUE = new org.kevoree.modeling.api.abs.AbstractMetaAttribute("value", 9, 0, false, org.kevoree.modeling.api.meta.PrimitiveTypes.STRING, org.kevoree.modeling.api.extrapolation.DiscreteExtrapolation.instance());
                MetaSimulatedParameter.REF_PERIOD = new org.kevoree.modeling.api.abs.AbstractMetaReference("period", 10, true, true, function () {
                    return org.kubi.meta.MetaPeriod.getInstance();
                }, null, function () {
