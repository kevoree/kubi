...
(function (org) {
    var kubi;
    (function (kubi) {
        var StateMachineModel = (function (_super) {
            __extends(StateMachineModel, _super);
            function StateMachineModel() {
                _super.call(this);
                this._metaModel = new org.kevoree.modeling.meta.impl.MetaModel("StateMachine");
                var tempMetaClasses = new Array();
                tempMetaClasses[1] = org.synoptic.meta.MetaState.getInstance();
                tempMetaClasses[0] = org.synoptic.meta.MetaStateMachine.getInstance();
                tempMetaClasses[2] = org.synoptic.meta.MetaTransition.getInstance();
                this._metaModel.init(tempMetaClasses);
            }
            StateMachineModel.prototype.internalCreateUniverse = function (key) {
                return new org.kubi.StateMachineUniverse(key, this._manager);
            };
            StateMachineModel.prototype.metaModel = function () {
                return this._metaModel;
            };
            StateMachineModel.prototype.internalCreateObject = function (universe, time, uuid, p_clazz) {
                if (p_clazz == null) {
                    return null;
                }
            ...
            StateMachineModel.prototype.createState = function (universe, time) {
                return this.create(org.synoptic.meta.MetaState.getInstance(), universe, time);
            };
            StateMachineModel.prototype.createStateMachine = function (universe, time) {
                return this.create(org.synoptic.meta.MetaStateMachine.getInstance(), universe, time);
            };
            StateMachineModel.prototype.createTransition = function (universe, time) {
                return this.create(org.synoptic.meta.MetaTransition.getInstance(), universe, time);
            };
            return StateMachineModel;
        })(org.kevoree.modeling.abs.AbstractKModel);
        kubi.StateMachineModel = StateMachineModel;
        var StateMachineUniverse = (function (_super) {
            __extends(StateMachineUniverse, _super);
            function StateMachineUniverse(p_key, p_manager) {
                _super.call(this, p_key, p_manager);
            }
            StateMachineUniverse.prototype.internal_create = function (timePoint) {
                return new org.kubi.impl.StateMachineViewImpl(this._universe, timePoint, this._manager);
            };
            return StateMachineUniverse;
        })(org.kevoree.modeling.abs.AbstractKUniverse);
        kubi.StateMachineUniverse = StateMachineUniverse;
        var impl;
        (function (impl) {
            var StateMachineViewImpl = (function (_super) {
                __extends(StateMachineViewImpl, _super);
                function StateMachineViewImpl(p_universe, _time, p_manager) {
                    _super.call(this, p_universe, _time, p_manager);
                }
                StateMachineViewImpl.prototype.createState = function () {
                    return this.create(org.synoptic.meta.MetaState.getInstance());
                };
                StateMachineViewImpl.prototype.createStateMachine = function () {
                    return this.create(org.synoptic.meta.MetaStateMachine.getInstance());
                };
                StateMachineViewImpl.prototype.createTransition = function () {
                    return this.create(org.synoptic.meta.MetaTransition.getInstance());
                };
                return StateMachineViewImpl;
            })(org.kevoree.modeling.abs.AbstractKView);
            impl.StateMachineViewImpl = StateMachineViewImpl;
    ...
    (function (synoptic) {
        ...
        (function (meta) {
            var MetaState = (function (_super) {
                ...
                function MetaState() {
                    _super.call(this, "org.synoptic.State", 1, null);
            ...
            var MetaStateMachine = (function (_super) {
                ...
                function MetaStateMachine() {
                    _super.call(this, "org.synoptic.StateMachine", 0, null);
                    var temp_all = new Array();
                    temp_all[0] = MetaStateMachine.ATT_NAME;
                    var temp_references = new Array();
                    temp_all[1] = MetaStateMachine.REF_CURRENTSTATE;
                    temp_all[2] = MetaStateMachine.REF_STATES;
                    var temp_operations = new Array();
                    this.init(temp_all);
                }
                ...
                MetaStateMachine.REF_CURRENTSTATE = new org.kevoree.modeling.meta.impl.MetaReference("currentState", 1, true, true, function () {
                    return org.synoptic.meta.MetaState.getInstance();
                }, "op_currentState", function () {
                    return org.synoptic.meta.MetaStateMachine.getInstance();
                });
                MetaStateMachine.REF_STATES = new org.kevoree.modeling.meta.impl.MetaReference("states", 2, true, false, function () {
                    return org.synoptic.meta.MetaState.getInstance();
                }, "op_states", function () {
                    return org.synoptic.meta.MetaStateMachine.getInstance();
                });
            ...
            var MetaTransition = (function (_super) {
                ...
                function MetaTransition() {
                    _super.call(this, "org.synoptic.Transition", 2, null);
                    var temp_all = new Array();
