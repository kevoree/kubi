...
(function () {
    ...
    function z(a, b, c, d) {
        ...
        if (this._options.stripLines && 0 < this._options.stripLines.length)for (this.stripLines = [], b = 0; b < this._options.stripLines.length; b++)this.stripLines.push(new la(this.chart, this._options.stripLines[b], a.theme,
    ...
    w.prototype._updateOptions = function () {
        ...
        if ("undefined" === typeof ha.Chart.creditHref)this.creditHref = "http://canvasjs.com/", this.creditText = ""; else var c = this.updateOption("creditText"), d = this.updateOption("creditHref");
    ...
    w.prototype.getDataPointAtXY = function (a, b, c) {
        ...
        a = null;
        b = !1;
        for (c = 0; c < d.length; c++)if ("line" === d[c].dataSeries.type || "stepLine" === d[c].dataSeries.type || "area" === d[c].dataSeries.type || "stepArea" === d[c].dataSeries.type)if (e = R("markerSize", d[c].dataPoint, d[c].dataSeries) || 8, d[c].distance <= e / 2) {
            b = !0;
            break
        }
    ...
    w.prototype.getObjectAtXY = function (a, b, c) {
        var d = null;
        if (c = this.getDataPointAtXY(a, b, c || !1))d = c.dataSeries.dataPointIds[c.dataPointIndex]; else if (u)d = ra(a, b, this._eventManager.ghostCtx); else for (c = 0; c < this.legend.items.length; c++) {
        ...
        if (this.interactivityEnabled) {
            ...
            if (!e) {
                if (w.capturedEventParam)d = w.capturedEventParam, "mouseup" === c && (w.capturedEventParam =
                    null, d.chart.overlaidCanvas.releaseCapture ? d.chart.overlaidCanvas.releaseCapture() : document.body.removeEventListener("mouseup", d.chart._mouseEventHandler, !1)), d.hasOwnProperty(c) && d[c].call(d.context, b.x, b.y); else if (this._events) {
        ...
        if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) && this.isDrag) {
            ...
            if (2 < Math.abs(e)) {
                if (this.panEnabled)e = !1, d = 0, this.axisX.sessionVariables.internalMinimum < this.axisX._absoluteMinimum ? (d = this.axisX._absoluteMinimum - this.axisX.sessionVariables.internalMinimum, this.axisX.sessionVariables.internalMinimum += d, this.axisX.sessionVariables.internalMaximum += d, e = !0) : this.axisX.sessionVariables.internalMaximum > this.axisX._absoluteMaximum && (d = this.axisX.sessionVariables.internalMaximum - this.axisX._absoluteMaximum, this.axisX.sessionVariables.internalMaximum -=
                    d, this.axisX.sessionVariables.internalMinimum -= d, e = !0), e && this.render(); else if (this.zoomEnabled) {
    ...
    w.prototype.renderLine = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var d = [], e = 0; e < a.dataSeriesIndexes.length; e++) {
                ...
                b.beginPath();
                if (0 < l.length) {
                    for (var r = !1, k = 0; k < l.length; k++)if (n = l[k].x.getTime ? l[k].x.getTime() : l[k].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax))if ("number" !== typeof l[k].y)0 < k && (b.stroke(), u && c.stroke()), r = !0; else {
    ...
    w.prototype.renderStepLine = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var d = [], e = 0; e < a.dataSeriesIndexes.length; e++) {
                ...
                b.beginPath();
                if (0 < l.length) {
                    for (var r = !1, k = 0; k < l.length; k++)if (n =
                            l[k].getTime ? l[k].x.getTime() : l[k].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax))if ("number" !== typeof l[k].y)0 < k && (b.stroke(), u && c.stroke()), r = !0; else {
                        var p = m;
                        ...
                        {id: s, objectType: "dataPoint", dataSeriesIndex: f, dataPointIndex: k, x1: n, y1: m};
    ...
    w.prototype.renderSpline = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var e = [], f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                var k = 0, n, m, r = [];
                c.beginPath();
                if (0 < q.length)for (k = 0; k < q.length; k++)if (n = q[k].getTime ? q[k].x.getTime() : q[k].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax))if ("number" !== typeof q[k].y)0 < k && (b(r), r = []); else {
    ...
    w.prototype.renderColumn = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (d = 0; d < a.dataSeriesIndexes.length; d++) {
                ...
                if (0 < m.length)for (var r = 5 < k &&
                n.bevelEnabled ? !0 : !1, e = 0; e < m.length; e++)if (m[e].getTime ? l = m[e].x.getTime() : l = m[e].x, !(l < a.axisX.dataInfo.viewPortMin || l > a.axisX.dataInfo.viewPortMax) && "number" === typeof m[e].y) {
    ...
    w.prototype.renderStackedColumn100 = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                var n = a.dataSeriesIndexes[h], m = this.data[n], r = m.dataPoints;
                if (0 < r.length)for (var p = 5 < k && m.bevelEnabled ? !0 : !1, g = 0; g < r.length; g++)if (c =
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (h = 0; h < a.dataSeriesIndexes.length; h++) {
                ...
                if (0 < r.length) {
                    var p = 5 < k && m.bevelEnabled ? !0 : !1;
                    b.strokeStyle = "#4572A7 ";
                    for (g = 0; g < r.length; g++)if (c = r[g].x.getTime ?
    ...
    w.prototype.renderArea = function (a) {
        function b() {
            x && (0 < h.lineThickness && c.stroke(), 0 >= a.axisY.minimum && 0 <= a.axisY.maximum ? t = v : 0 > a.axisY.maximum ? t = f.y1 : 0 < a.axisY.minimum && (t = e.y2), c.lineTo(r, t), c.lineTo(x.x, t), c.closePath(), c.globalAlpha = h.fillOpacity, c.fill(), c.globalAlpha = 1, u && (d.lineTo(r, t), d.lineTo(x.x, t), d.closePath(), d.fill()), c.beginPath(),
                c.moveTo(r, p), d.beginPath(), d.moveTo(r, p), x = {x: r, y: p})
        }
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (l = 0; l < a.dataSeriesIndexes.length; l++) {
                ...
                if (0 < k.length) {
                    ...
                    for (var V = !0; m < k.length; m++)if (s = k[m].x.getTime ? k[m].x.getTime() : k[m].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax))if ("number" !== typeof k[m].y)b(),
                        V = !0; else {
                        ...
                        this._eventManager.objectMap[B] = {
                            id: B, objectType: "dataPoint", dataSeriesIndex: q,
                            dataPointIndex: m, x1: r, y1: p
                        };
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    if (0 < k.length) {
                        ...
                        c.fillStyle = color;
                        c.strokeStyle = color;
                        for (c.lineWidth = h.lineThickness; n < k.length; n++)if (m = k[n].x.getTime ? k[n].x.getTime() : k[n].x, !(m < a.axisX.dataInfo.viewPortMin ||
                            m > a.axisX.dataInfo.viewPortMax))if ("number" !== typeof k[n].y)0 < n && (b(), t = []); else {
                ...
                if (0 < k.length) {
                    ...
                    for (c.lineWidth = h.lineThickness; m < k.length; m++)if (s = k[m].x.getTime ? k[m].x.getTime() : k[m].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax)) {
                        ...
                        (k[m].y - a.axisY.conversionParameters.minimum) + 0.5 << 0, n || E ? (c.beginPath(), c.moveTo(r, p), x = {
                            ...
                            x: r, y: p, ctx: d, type: s.type, size: s.size,
                            color: B, borderColor: B, borderThickness: s.borderThickness
                        })), (k[m].indexLabel || h.indexLabel) && this._indexLabels.push({
                            chartType: "stepArea",
                            dataPoint: k[m],
                            dataSeries: h,
    ...
    w.prototype.renderStackedArea = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (e = 0; e < a.dataSeriesIndexes.length; e++) {
                ...
                p.dataPointIndexes = [];
                for (l = 0; l < s.length; l++)r = s[l].x.getTime ? s[l].x.getTime() : s[l].x, p.dataPointIndexes[r] = l, xValuePresent[r] || (g.push(r), xValuePresent[r] = !0);
                g.sort(pa)
            }
            for (e = 0; e < a.dataSeriesIndexes.length; e++) {
                ...
                if (0 < g.length) {
                    ...
                    for (l = 0; l < g.length; l++) {
                        k = g[l];
                        var x = null, x = 0 <= p.dataPointIndexes[k] ? s[p.dataPointIndexes[k]] : {x: k, y: 0};
                        if (!(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && "number" === typeof x.y) {
                            ...
                            t.push({x: q, y: n - E});
                            f[k] = n - h;
                            if (v)b.beginPath(), b.moveTo(q, h), u && (m.beginPath(), m.moveTo(q, h)), v = !1; else if (b.lineTo(q, h), u && m.lineTo(q, h), 0 == l % 250) {
                    ...
                    for (0 < p.lineThickness && b.stroke(); 0 < t.length;)w = t.pop(), b.lineTo(w.x, w.y), u && m.lineTo(w.x, w.y);
                    b.closePath();
                    b.globalAlpha = p.fillOpacity;
                    b.fill();
                    b.globalAlpha = 1;
    ...
    w.prototype.renderStackedArea100 = function (a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (d = 0; d < a.dataSeriesIndexes.length; d++) {
                ...
                v.dataPointIndexes = [];
                for (l = 0; l < t.length; l++)s = t[l].x.getTime ? t[l].x.getTime() : t[l].x, v.dataPointIndexes[s] = l, xValuePresent[s] || (g.push(s), xValuePresent[s] = !0);
                g.sort(pa)
            }
            for (d = 0; d <
            a.dataSeriesIndexes.length; d++) {
                ...
                if (0 < g.length) {
                    ...
                    for (l = 0; l < g.length; l++) {
                        k = g[l];
                        var w = null, w = 0 <= v.dataPointIndexes[k] ? t[v.dataPointIndexes[k]] : {x: k, y: 0};
                        if (!(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) &&
                            ...
                            E.push({x: q, y: n - B});
                            f[k] = n - h;
                            if (x)b.beginPath(), b.moveTo(q, h), u && (p.beginPath(), p.moveTo(q, h)), x = !1; else if (b.lineTo(q, h), u && p.lineTo(q,
                                    h), 0 == l % 250) {
                    ...
                    for (0 < v.lineThickness && b.stroke(); 0 < E.length;)G = E.pop(), b.lineTo(G.x, G.y), u && p.lineTo(G.x, G.y);
                    b.closePath();
                    b.globalAlpha = v.fillOpacity;
                    b.fill();
                    b.globalAlpha = 1;
    ...
    w.prototype.renderBubble = function (a) {
        ...
        if (!(0 >= c)) {
            ...
            b.clip();
            u && (this._eventManager.ghostCtx.rect(d.x1, d.y1, d.width, d.height), this._eventManager.ghostCtx.clip());
            for (var q = -Infinity, h = Infinity, k = 0; k < a.dataSeriesIndexes.length; k++)for (var n = a.dataSeriesIndexes[k], m = this.data[n], r = m.dataPoints, p = 0, e = 0; e < r.length; e++)f = r[e].getTime ? f = r[e].x.getTime() : f = r[e].x, f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax || "undefined" === typeof r[e].z || (p = r[e].z, p > q && (q = p), p < h && (h = p));
            for (var s = 25 * Math.PI,
                ...
                this._eventManager.objectMap[t] = {
                    id: t, objectType: "dataPoint", dataSeriesIndex: n, dataPointIndex: e,
                    x1: f, y1: g, size: v
                };
                v = A(t);
        ...
        if (!(0 >= c)) {
            ...
            for (var q = 0; q < a.dataSeriesIndexes.length; q++) {
                ...
                if (0 < n.length) {
                    ...
                    for (var m =
                        0, r = 0, e = 0; e < n.length; e++)if (f = n[e].getTime ? f = n[e].x.getTime() : f = n[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof n[e].y) {
                        ...
                        Math.sqrt((m - f) * (m - f) + (r - g) * (r - g)) < Math.min(p.size, 5) && n.length > Math.min(this.plotArea.width, this.plotArea.height) || (m = k.dataPointIds[e], this._eventManager.objectMap[m] = {
                            ...
                            chartType: "scatter", dataPoint: n[e],
                            dataSeries: k, point: {x: f, y: g}, direction: 1, color: null
                        }), m = f, r = g)
                    }
                }
            }
            ...
            for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                ...
                if (0 < s.length)for (var v = 5 < n && p.bevelEnabled ? !0 : !1, e = 0; e < s.length; e++)if (s[e].getTime ? k = s[e].x.getTime() : k = s[e].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && null !== s[e].y && s[e].y.length && "number" === typeof s[e].y[0] && "number" === typeof s[e].y[1] && "number" === typeof s[e].y[2] && "number" === typeof s[e].y[3]) {
                    ...
                    (s[e].indexLabel || p.indexLabel) && this._indexLabels.push({
                        ...
                        direction: 1,
                        bounds: {
                            x1: t, y1: Math.min(l, q), x2: x, y2: Math.max(l,
                                q)
                        },
                        color: d
                    })
    ...
    z.prototype.createLabels = function () {
        ...
        if ("axisX" === this.type && "dateTime" === this.chart.plotInfo.axisXValueType)for (c = oa(new Date(this.maximum), this.interval, this.intervalType), b = this.intervalStartPosition; b < c; oa(b, this.interval,
    ...
    w.prototype.replaceKeywordsWithValue = function (a, b, c, d, e) {
        ...
        if ((0 <= c.type.indexOf("stacked") || "pie" === c.type ||
            ...
            if (0 <= c.type.indexOf("stacked"))l = 0, 0 < c.plotUnit.yTotals.length && (l = c.plotUnit.yTotals[b.x], g = isNaN(b.y) ? 0 : 100 * (b.y / l)); else if ("pie" === c.type || "doughnut" === c.type) {
                for (i = l = 0; i < c.dataPoints.length; i++)isNaN(c.dataPoints[i].y) || (l += c.dataPoints[i].y);
                g = isNaN(b.y) ? 0 : 100 * (b.y / l)
            }
            do {
                var q = "";
                if (c.percentFormatString)q = c.percentFormatString; else for (var q = "#,##0.", h = Math.max(Math.ceil(Math.log(1 / g) / Math.LN10),
                    2), k = 0; k < h; k++)q += "#";
